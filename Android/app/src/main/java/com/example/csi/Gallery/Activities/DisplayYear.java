...
public class DisplayYear extends AppCompatActivity implements EventNameAdapter.OnItemClickListener, ExampleDialogue.ExampleDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PARENT_DIR = intent.getStringExtra(EXTRA_EVENT);
    ...
    private void parseJSON() {
        ...
        String url = getApplicationContext().getResources().getString(R.string.gallery_url) + "/event";    //Main Server URL
        //String url = "http://192.168.42.156:8080/event";

        //creating jsonobject starts
        final JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("path", PARENT_DIR);
        }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,url,new Response.Listener<String>(){
            ...
            public void onResponse(String response) {
                ...
                //Toast.makeText(DisplayYear.this, "Logged IN", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    mEventNameAdapter.setOnItemClickListener(DisplayYear.this);
                }
                catch (JSONException e) {
                    e.printStackTrace();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try{
                    ...
                    Toast.makeText(DisplayYear.this, "Invalid", Toast.LENGTH_SHORT).show(); //This method is used to show pop-up on the screen if user gives wrong uid


                    error.printStackTrace();}
                catch (Exception e)
                {
                    Toast.makeText(DisplayYear.this,"Check Network",Toast.LENGTH_SHORT).show();}
            }
        }){
    ...
    public void onItemClick(int position) {
        if (position == mEventList.size()-1) {
            ...
            Intent displayImage = new Intent(this, DisplayImage.class);
            EventItem clickedItem = mEventList.get(position);
            displayImage.putExtra("YEAR", PARENT_DIR + clickedItem.getEventName() + "/");
    ...
    private void createDirectory(final String Directory) {
        ...
        String url = getApplicationContext().getResources().getString(R.string.gallery_url) + "/mkdir";    //Main Server URL
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,url,new Response.Listener<String>(){
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                try{
                    Log.i("volleyABC" ,Integer.toString(error.networkResponse.statusCode));
                    Toast.makeText(DisplayYear.this, "Something went wrong", Toast.LENGTH_SHORT).show(); //This method is used to show pop-up on the screen if user gives wrong uid
